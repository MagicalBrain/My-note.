#pragma once
#include "../include/practice3_1.h"


practice3_1::practice3_1()
{
}
...
string practice3_1::readFile(string filePath) {
	cout << filePath << endl;
	string content;
...
* 创建着色器程序
*/
GLuint practice3_1::createShaderProgram() {
	GLint vertCompiled;
	GLint fragCompiled;
	GLint linked;
	...
	*/
	...
	// 使用反斜杠
	target << path.string() << "/shader/vertShaderP3_1.glsl";
	...
	// 使用两个斜杠 都是可以的
	target << path.string() << "\\shader\\fragShaderP3_1.glsl";
...
void practice3_1::init(GLFWwindow* window)
{
...
void practice3_1::display(GLFWwindow* window, double currentTime)
{
	// 每次都将背景清除为黑色
...
int practice3_1::test()
{
	...
	// 实例化GLFW window
	GLFWwindow* window = glfwCreateWindow(600, 600, "Chapter 3 - practice 1", NULL, NULL);
	/*
