#include "../include/practice2_1.h"

practice2_1::practice2_1()
{
}
...
string practice2_1::readFile(string filePath) {
	cout << filePath << endl;
	string content;
...
* 创建着色器程序
*/
GLuint practice2_1::createShaderProgram() {
	...
	*/
	...
	// 使用反斜杠
	target << path.string() << "/shader/vertShaderP2_1.glsl";
	...
	// 使用两个斜杠 都是可以的
	target << path.string() << "\\shader\\fragShaderP2_1.glsl";
...
void practice2_1::init(GLFWwindow* window)
{
...
void practice2_1::display(GLFWwindow* window, double currentTime)
{
	// 每次都将背景清除为黑色
...
int practice2_1::test()
{
	...
	// 实例化GLFW window
	GLFWwindow* window = glfwCreateWindow(600, 600, "Chapter 2 - practice 1", NULL, NULL);
	/*
